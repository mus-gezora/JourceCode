...
-- to do a space, add \n
local creditStuff = ' > credits:\nMusic by Street Sign\nChart by mus_gezora and flakyflakes\nArt by ThisIsntGood and flakyflakes\nSoretro art by Gianna'
