...
class Achievements {
	public static function init()
	{
		...
		createAchievement('fridayniteweek1_nomiss',		{name: "Joe Your Place!", description: "Beat Joe's Week with no misses."});
		createAchievement('injroe_mania_nomiss',		{name: "A Maniacle Injroeduction!", description: "Beat Injroe's Mania chart with no misses."});
		createAchievement('irresponsible_mania_nomiss',	{name: "Irresponsible Mania", description: "Beat Irresponsible's Mania chart with no misses."});
		createAchievement('parole_mania_nomiss',		{name: "Out of the Assylum", description: "Beat Parole's Mania chart with no misses."});
		createAchievement('hilarious__nomiss',			{name: "I'm running out of achievement name ideas.", description: "Beat Hilarious with no misses."});
