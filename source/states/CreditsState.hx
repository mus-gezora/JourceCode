...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Vs Joe Team"],
			["mus_gezora", "gezora", "Founder, Director, Main Composer and Charter", "https://www.youtube.com/@mus_gezora", "05BAF8"],
			...
			["flakyflakes", "flaky", "Artist, Animator, Charter and Main Programmer", "https://twitter.com/realHTFWiki", "FF0000"],
			...
			[""],
			["Mod Contributors"],
			["iwanttokommitdead", "kommit", "Pause Menu", "https://www.youtube.com/channel/UCTPdC9wWSEL1Gk4MB5qH-pg", "999999"],
			[""],
			["Psych Engine Team"],
			...
			[""],
			["Vs. Joe Discord"],
			["Join the Disjord!", "discord", "", "https://discord.gg/fxFAvFQ3tU", "5165F6"]
		];
